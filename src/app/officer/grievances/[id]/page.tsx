    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] text-slate-900 font-sans selection:bg-blue-500/30">
            ...
            <main className="relative z-10 mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8 animate-fade-in">
                <div className="mb-8">
                    <Link href="/officer/cases" className="inline-flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-blue-600 transition-colors mb-4">
                ...
                <div className="grid gap-8 lg:grid-cols-3">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex flex-wrap items-center gap-4 text-sm font-medium text-slate-500 pt-6 border-t border-slate-100">
                                    <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-100">
                                        ...
                                        <span>Submitted {new Date(grievance.createdAt).toLocaleDateString(undefined, { month: 'short', day: 'numeric', year: 'numeric' })}</span>
                                    </div>
                                    <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-50 border border-slate-100">
                                        <ClockIcon className="h-4 w-4 text-slate-400" />
                        ...
                        <div className="rounded-3xl border border-slate-200/60 bg-white shadow-sm p-6 sm:p-8">
                            ...
                            <div className="space-y-6 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-200 before:to-transparent">
                                {grievance.history.map((entry, index) => {
                                    const isLatest = index === 0; // The history is ordered by desc, so 0 is latest
                                    return (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="rounded-3xl border border-slate-200/60 bg-white p-6 shadow-sm shadow-blue-500/5 relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-blue-50 rounded-bl-full -mr-16 -mt-16 pointer-events-none"></div>
                            ...
                            <form action={updateStatus} className="space-y-5 relative z-10">
                                ...
                                <div>
                                    ...
                                    <select name="status" defaultValue={grievance.status} className="block w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-sm font-bold text-slate-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:bg-white transition-all appearance-none cursor-pointer">
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Add Remark</label>
                                    <textarea name="note" rows={3} className="block w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-sm font-medium text-slate-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:bg-white transition-all placeholder:text-slate-400" placeholder="Describe the progress or reason for status change..." />
                                </div>
                        ...
                        <div className="rounded-3xl border border-slate-200/60 bg-white p-6 shadow-sm">
                            ...
                            <div className="space-y-3 pt-5 border-t border-slate-100">
                                ...
                                <div className="flex items-start justify-between">
                                    ...
                                    <p className="text-sm font-bold text-slate-900 text-right max-w-[150px] leading-tight">{grievance.address || "Not provided"}</p>
                                </div>
                            </div>
                        </div>
                    </div>
